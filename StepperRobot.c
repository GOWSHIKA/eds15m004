...
StateType Fsm[4] = {
  {0x0A, 1, {0, 1, 2, 3} }, // S0) both move forward
  {0x06, 1, {0, 1, 2, 3} }, // S1) Left forward ,right backward
  {0x09, 1, {0, 1, 2, 3} }, // S2) Left backward, right forward
  {0x05, 1, {0, 1, 2, 3} } // S3) both backward
